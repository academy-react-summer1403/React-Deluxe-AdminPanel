      ...
      <Form onSubmit={e => e.preventDefault()}>
        <Row>
          <Col md='6' className='mb-1'>
            ...
            <Input type='text' name='first-name' id={`first-name-${type}`} placeholder='' />
          </Col>
          <Col md='6' className='mb-1'>
            <Label className='form-label' for={`last-name-${type}`}>
              اسناد دوره
            </Label>
            <Input type='text' name='last-name' id={`last-name-${type}`} placeholder='' />
          </Col>
        </Row>
        <Row>
          <Col md='6' className='mb-1'>
        ...
        <div className='d-flex justify-content-between'>
          <Button color='primary' className='btn-prev' onClick={() => stepper.previous()}>
            ...
            <span className='align-middle d-sm-inline-block d-none'>مرحله قبلی</span>
          </Button>
