...
const StatsCard = ({ Report, cols }) => {
  ...
  const data = [
    ...
    },
    {
      ...
      subtitle: "کاربرهای غیرفعال",
      color: "light-danger",
      icon: <UserBlock01Icon size={24} />,
    },
    {
      title: Report?.allUser - Report?.deactiveUsers,
      subtitle: "کاربرهای فعال",
      color: "light-success",
      icon: <UserCheck02Icon size={24} />,
    },
    // {
  ...
  return (
    <Card className="card-statistics d-flex flex-column justify-content-center">
      ...
      <CardBody
        className="statistics-body d-flex align-items-center"
        style={{ height: "20rem" }}
      >
        <Row
